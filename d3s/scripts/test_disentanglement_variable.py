...
class DisentanglementTestingModel(nn.Module):
    def __init__(self, model, fg_classes=1000, bg_classes=10):
        ...
        self.fg_head = nn.Linear(self.model.disentangle.num_features - self.model.disentangle.split, fg_classes)
        self.bg_head = nn.Linear(self.model.disentangle.split, bg_classes)
